...
export const MODES = [
  ...
  { id: 'neural',      name: 'NEURAL FIELD',        sub: 'live FitzHugh–Nagumo' },
  { id: 'turing',      name: 'TURING FLUX',         sub: 'live Gray–Scott RD' },
  { id: 'mandala',     name: 'SACRED GEOM',         sub: 'phyllotaxis · symmetry' },
  { id: 'flow',        name: 'BREATHING WALLS',     sub: 'domain-warped fBm' },
  { id: 'hyper',       name: 'HYPERSPACE',          sub: '2D / 3D ray · R toggle' },
  ...
  { id: 'lizard',      name: 'DRAGONSCALES',        sub: 'live cyclic CA' },
  { id: 'waveform',    name: 'WAVEFORM',            sub: 'oscilloscope · vectorscope' },
  { id: 'fractal',     name: 'FRACTAL',             sub: 'Mandelbox flythrough · 3D' },
  { id: 'particles',   name: 'PARTICLE FLOW',       sub: 'live advected density' },
  { id: 'weier',       name: 'WEIER WELLS',         sub: 'elliptic ℘ · complex crystal' },
  { id: 'blaschke',    name: 'BLASCHKE',            sub: 'conformal disc · flower' },
  { id: 'indra',       name: 'INDRA',               sub: 'Kleinian limit set · pearls' },
  { id: 'arnold',      name: 'ARNOLD',              sub: 'circle-map · staircase' },
  { id: 'gauss',       name: 'GAUSSIAN HALO',       sub: 'ℤ[i] primes' },
  ...
  { id: 'denom',       name: 'DENOM DESCENT',       sub: 'modular Farey' },
  { id: 'wave',        name: 'WAVE CRYSTAL',        sub: 'sine-Gordon breathers' },
  { id: 'phase',       name: 'PHASE PORTAL',        sub: 'continued-fraction field' },
  { id: 'vortex',      name: 'VORTEX FIELD',        sub: 'Abrikosov lattice' },
  { id: 'fluid',        name: 'FLUID',               sub: 'Navier–Stokes live' },
...
export const presets: Preset[] = [
  ...
  },
  {
    ...
    params: { mode: 14, palette: 6, dose: 0.6, speed: 0.7, complexity: 0.5, symmetry: 5, trail: 0.5, cinematic: true, tone: 0.6 },
  },
  {
  ...
  {
    name: 'Spiral Waves',
    params: { mode: 21, palette: 4, dose: 0.55, speed: 0.9, complexity: 0.55, symmetry: 5, trail: 0.4, reactivity: 0.7, cinematic: true },
  },
  {
    name: 'Live Scope',
    params: { mode: 13, palette: 0, dose: 0.3, speed: 1.0, complexity: 0.3, symmetry: 6, trail: 0.1, reactivity: 1.0, scope: true, cinematic: false },
  },
  {
    name: 'Dark Ambient',
  ...
  {
    name: 'Penrose Loom',
    params: { mode: 22, palette: 0, dose: 0.5, speed: 0.7, complexity: 0.6, symmetry: 5, trail: 0.45, reactivity: 0.6, cinematic: true },
  },
  {
    name: 'Vortex Lattice',
    params: { mode: 27, palette: 7, dose: 0.6, speed: 0.8, complexity: 0.5, symmetry: 6, trail: 0.5, cinematic: true },
  },
]
